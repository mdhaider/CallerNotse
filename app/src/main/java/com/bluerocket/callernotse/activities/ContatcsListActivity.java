...
import com.bluerocket.callernotse.adapters.DesignDemoPagerAdapter;

/**
 * Created by nehal on 11/23/2017.
 */

public class ContatcsListActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_contatcs_list);
